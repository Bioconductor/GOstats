...
entrezIds <- mget(featureNames(bcrAblOrNeg), envir=hgu95av2LOCUSID)
...
entrezUniverse <- unlist(mget(affyUniverse, hgu95av2LOCUSID))
...
chipEntrezUniverse <- mget(chipAffyUniverse, hgu95av2LOCUSID)
