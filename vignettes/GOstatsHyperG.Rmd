...
The [GOstats](https://bioconductor.org/packages/release/bioc/html/GOstats.html) package has extensive facilities for testing
...
conditioning (similar to that presented in  @Alexa06).
...
```{r nsFiltering-noGO, results='hide', echo=TRUE, cache=TRUE} 
...
and *PFAMHyperGParams* defined in the **`Category`{.sans-serif}** package
...
|           [YEAST]{.sans-serif} annotation package, the vector will consist of yeast systematic names.
