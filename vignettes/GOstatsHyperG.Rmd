...
possible genes. We recommend using the set of gene IDs that result from non-specific filtering.The identifiers should be of the same type as the `geneIds`; for 
...
**ontology** A two-letter string specifying one of the three GO ontologies:BP, CC,
or MF. The `hyperGTest` function only tests a single GO ontology at one time.
